...
- **Чеклист внутри задачи.** Большую задачу можно разложить на мини-задачи: счётчик «сделано/всего» на свёрнутой карточке, пункты — под заметкой. Клавиши те же, что у списка задач. Поиск ищет и по пунктам. Сколько пунктов видно без прокрутки — в настройках, чтобы длинный список не растянул одну задачу на всё окно.
