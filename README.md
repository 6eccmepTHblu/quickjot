...
- **Чеклист внутри задачи.** Большую задачу можно разложить на мини-задачи: счётчик «сделано/всего» на свёрнутой карточке, пункты — под заметкой. Клавиши те же, что у списка задач. Поиск ищет и по пунктам.
